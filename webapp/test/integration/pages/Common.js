sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("smartfilterbar44/app", ".html");
		...
		return Opa5.extend("smartfilterbar44.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["smartfilterbar44/localService/mockserver"], function (mockserver) {
